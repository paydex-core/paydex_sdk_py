...
from paydex_base_sdk.exceptions import MemoInvalidException
from paydex_base_sdk.memo import NoneMemo, Memo, TextMemo, IdMemo, HashMemo, ReturnHashMemo
...
class TestMemo:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (b"Paydex", "AAAAAQAAAAdTdGVsbGFyAA=="),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TextMemo("PAYDEX"), TextMemo("PAYDEX"), True),
            (
                HashMemo(
                    binascii.unhexlify(
