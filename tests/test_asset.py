...
from paydex_base_sdk.xdr import Xdr
from paydex_base_sdk.asset import Asset
from paydex_base_sdk.exceptions import AssetIssuerInvalidError, AssetCodeInvalidError
...
class TestAsset:
    ...
    def test_native_asset(self):
        asset_1 = Asset("PAYDEX")
        asset_2 = Asset.native()
        assert asset_1 == asset_2
        assert asset_1.code == "PAYDEX"
