...
class CreatePassiveSellOffer(Operation):
    ...
    CreatePassiveSellOffer operation on Paydex's network.
    ...
    example, if an offer exists to buy 5 BTC for 30 PAYDEX, and you make a passive
    sell offer to buy 30 PAYDEX for 5 BTC, your passive sell offer does not take the first
    offer.
