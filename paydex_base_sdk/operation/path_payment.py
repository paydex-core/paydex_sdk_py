...
class PathPayment(PathPaymentStrictReceive):
    ...
    operation on Paydex's network.

    Sends an amount in a specific asset to a destination account through a path
    of offers. This allows the asset sent (e.g. 450 PAYDEX) to be different from
    ...
    def __init__(
        ...
        warnings.warn(
            ...
            "use paydex_sdk.operation.PathPaymentStrictReceive",
            DeprecationWarning,
        )
        super().__init__(
