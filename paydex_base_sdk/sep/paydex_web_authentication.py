"""
SEP: 0010
Title: Paydex Web Authentication
Author: Paydex
Status: Active
Created: 2020-1-10
Updated: 2020-3-12
...
def build_challenge_transaction(
    ...
    """
    challenge transaction which you can use for Paydex Web Authentication.

    :param server_secret: secret key for server's signing account.
    :param client_account_id: The paydex account that the wallet wishes to authenticate with the server.
    ...
    :param network_passphrase: The network to connect to for verifying and retrieving
        additional attributes from. (ex. 'paydex open-chain test-newtwork; March 2020')
...
def read_challenge_transaction(
    ...
    one of the following functions to completely verify the transaction:
        - :func:`paydex_sdk.sep.paydex_web_authentication.verify_challenge_transaction_threshold`
        - :func:`paydex_sdk.sep.paydex_web_authentication.verify_challenge_transaction_signers`
    ...
    :param network_passphrase: The network to connect to for verifying and retrieving
        additional attributes from. (ex. 'paydex open-chain test-newtwork; March 2020')
    :raises: :exc:`InvalidSep10ChallengeError <paydex_sdk.sep.exceptions.InvalidSep10ChallengeError>` - if the
        validation fails, the exception will be thrown.
    """

    # decode the received input as a base64-urlencoded XDR representation of Paydex transaction envelope
    try:
...
def verify_challenge_transaction_signers(
    ...
    :raises: :exc:`InvalidSep10ChallengeError <paydex_sdk.sep.exceptions.InvalidSep10ChallengeError>`:
        - The transaction is invalid according to :func:`paydex_sdk.sep.paydex_web_authentication.read_challenge_transaction`.
...
def verify_challenge_transaction_signed_by_client(
    ...
    """An alias for :func:`paydex_sdk.sep.paydex_web_authentication.verify_challenge_transaction`.
    ...
    warnings.warn(
        ...
        "use paydex_sdk.sep.test_paydex_web_authentication.verify_challenge_transaction_signed_by_client_master_key",
        DeprecationWarning,
    )  # pragma: no cover
...
def verify_challenge_transaction_signed_by_client_master_key(
    ...
    :raises: :exc:`InvalidSep10ChallengeError <paydex-sdk.sep.exceptions.InvalidSep10ChallengeError>` - if the
        validation fails, the exception will be thrown.
    """
