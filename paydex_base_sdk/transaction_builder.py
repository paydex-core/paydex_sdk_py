...
class TransactionBuilder:
    ...
    <paydex_sdk.transaction_envelope.TransactionEnvelope>` using the given
    :class:`Account <paydex_sdk.account.Account>` as the transaction's "source account". The transaction will use
    ...
    Be careful about **unsubmitted transactions**! When you build a transaction, paydex-sdk automatically
    ...
    transaction, make sure to update the source account's sequence number with :meth:`paydex_sdk.Server.load_account`
    ...
    def from_xdr(xdr: str, network_passphrase: str) -> "TransactionBuilder":
        ...
        <paydex_sdk.transaction_envelope.TransactionEnvelope>` via an XDR
        object.
    ...
    def set_timeout(self, timeout: int) -> "TransactionBuilder":
        ...
        :return: This builder instance.
        :raises:
            :exc:`ValueError <paydex_sdk.exceptions.ValueError>`: if time_bound is already set.
        """
        if self.time_bounds:
            raise ValueError(
    ...
    def add_text_memo(self, memo_text: Union[str, bytes]) -> "TransactionBuilder":
        ...
        <paydex_sdk.memo.TextMemo>`.

        :param memo_text: The text for the memo to add.
        :return: This builder instance.
        :raises: :exc:`MemoInvalidException <paydex_sdk.exceptions.MemoInvalidException>`:
    ...
    def add_id_memo(self, memo_id: int) -> "TransactionBuilder":
        ...
        <paydex_sdk.memo.IdMemo>`.

        :param memo_id: A 64 bit unsigned integer to set as the memo.
        :return: This builder instance.
        :raises:
            :exc:`MemoInvalidException <paydex_sdk.exceptions.MemoInvalidException>`:
    ...
    def add_return_hash_memo(
        ...
        <paydex-sdk.memo.ReturnHashMemo>`.
        ...
        :return: This builder instance.
        :raises:
            :exc:`MemoInvalidException <paydex-sdk.exceptions.MemoInvalidException>`:
    ...
    def append_create_account_op(
        ...
        <paydex_sdk.operation.CreateAccount>` operation to the list of
        operations.

        :param destination: Account address that is created and funded.
        :param starting_balance: Amount of PAYDEX to send to the newly created
            account. This PAYDEX comes from the source account.
    ...
    def append_change_trust_op(
        ...
        """Append a :class:`ChangeTrust <paydex_sdk.operation.ChangeTrust>`
    ...
    def append_payment_op(
        ...
        asset_code: str = "PAYDEX",
        asset_issuer: Optional[str] = None,
        source: str = None,
    ) -> "TransactionBuilder":
        """Append a :class:`Payment <paydex-sdk.operation.Payment>` operation
    ...
    def append_path_payment_op(
        ...
        """Append a :class:`PathPayment <paydex_sdk.operation.PathPayment>`
        operation to the list of operations.
        ...
        warnings.warn(
            ...
            "use paydex_sdk.transaction_builder.append_path_payment_strict_receive_op",
            DeprecationWarning,
        )
    ...
    def append_path_payment_strict_receive_op(
        ...
        """Append a :class:`PathPaymentStrictReceive <paydex_sdk.operation.PathPaymentStrictReceive>`
        operation to the list of operations.
    ...
    def append_path_payment_strict_send_op(
        ...
        """Append a :class:`PathPaymentStrictSend <paydex_sdk.operation.PathPaymentStrictSend>`
        operation to the list of operations.
    ...
    def append_allow_trust_op(
        ...
        """Append an :class:`AllowTrust <paydex_sdk.operation.AllowTrust>`
        operation to the list of operations.
    ...
    def append_set_options_op(
        ...
        """Append a :class:`SetOptions <paydex_sdk.operation.SetOptions>`
        operation to the list of operations.
    ...
    def append_ed25519_public_key_signer(
        ...
        <paydex_sdk.operation.SetOptions` operation. This is a helper
    ...
    def append_pre_auth_tx_signer(
        ...
        :param pre_auth_tx_hash: The address of the new preAuthTx signer - obtained by calling ``hash`` on
            the :class:`TransactionEnvelope <paydex_sdk.transaction_envelope.TransactionEnvelope>`,
            a 32 byte hash or hex encoded string.
        :param weight: The weight of the new signer.
        :param source: The source account that is adding a signer to its
            list of signers.
    ...
    def append_manage_buy_offer_op(
        ...
        """Append a :class:`ManageBuyOffer <paydex_sdk.operation.ManageBuyOffer>`
        operation to the list of operations.
    ...
    def append_manage_sell_offer_op(
        ...
        """Append a :class:`ManageSellOffer <paydex_sdk.operation.ManageSellOffer>`
        operation to the list of operations.
    ...
    def append_create_passive_sell_offer_op(
        ...
        <paydex_sdk.operation.CreatePassiveSellOffer>` operation to the list of
        operations.
        ...
        :param source: The source address that is creating a passive offer
            on Paydex's distributed exchange.
        :return: This builder instance.
    ...
    def append_account_merge_op(
        ...
        <paydex_sdk.operation.AccountMerge>` operation to the list of
        operations.
    ...
    def append_inflation_op(self, source: str = None) -> "TransactionBuilder":
        ...
        <paydex_sdk.operation.Inflation>` operation to the list of
        operations.
    ...
    def append_manage_data_op(
        ...
        """Append a :class:`ManageData <paydex_sdk.operation.ManageData>`
        operation to the list of operations.
    ...
    def append_bump_sequence_op(
        ...
        """Append a :class:`BumpSequence <paydex_sdk.operation.BumpSequence>`
        operation to the list of operations.
