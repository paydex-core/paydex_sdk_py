...
class Account:
    ...
    account in Paydex network and its sequence number.

    Account tracks the sequence number as it is used
    by :class:`TransactionBuilder <paydex_sdk.transaction_builder.TransactionBuilder>`

    See `Accounts`_ For more information about the formats used for asset codes and how issuers
    work on Paydex's network,
    ...
    :raises:
        :exc:`Ed25519PublicKeyInvalidError <paydex_sdk.exceptions.Ed25519PublicKeyInvalidError>`: if ``account_id``
