...
class Transaction:
    ...
    <paydex_sdk.transaction_envelope.TransactionEnvelope>` which is
    then signed before being sent over the network.

    For more information on Transactions in Paydex, see `Paydex's guide
    on transactions`_.
    ...
    :param fee: The fee amount for the transaction, which should equal
          ...
          operations in the transaction. See `Paydex's latest documentation
          on fees
          for more information.
    :param operations: A list of operations objects (typically its
          subclasses as defined in :mod:`paydex_sdk.operation.Operation`.
    ...
    :param memo: The memo being sent with the transaction, being
          ...
          :class:`Memo <paydex_sdk.memo.Memo>` object.
    """
