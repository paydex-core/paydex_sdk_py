...
from .sep.mnemonic import Language, PaydexMnemonic
...
class Keypair:
    ...
    verifying key for use with the Paydex network.
    ...
    * :meth:`Keypair.from_public_key`
    ...
    def from_secret(cls, secret: str) -> "Keypair":
        ...
        :raise: :exc:`Ed25519SecretSeedInvalidError <paydex_sdk.exceptions.Ed25519SecretSeedInvalidError>`:
    ...
    def from_public_key(cls, public_key: str) -> "Keypair":
        ...
        :raise: :exc:`Ed25519PublicKeyInvalidError <paydex_sdk.exceptions.Ed25519PublicKeyInvalidError>`:
    ...
    def secret(self) -> str:
        ...
        :return: secret key
        :raise: :exc:`MissingEd25519SecretSeedError <paydex_sdk.exceptions.MissingEd25519SecretSeedError>`
    ...
    def verify(self, data: bytes, signature: bytes) -> None:
        ...
        :raise: :exc:`BadSignatureError <paydex_sdk.exceptions.BadSignatureError>`:
    ...
    def generate_mnemonic_phrase(
        ...
        """
        mnemonic_phrase = PaydexMnemonic(language).generate(strength)
    ...
    def from_mnemonic_phrase(
        ...
        """
        raw_ed25519_seed = PaydexMnemonic.to_seed(mnemonic_phrase, passphrase, index)
