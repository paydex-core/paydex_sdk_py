...
class TransactionEnvelope:
    ...
    class handles signing and conversion to and from XDR for usage on Paydex's
    network.
    ...
    def sign(self, signer: Union[Keypair, str]) -> None:
        ...
        :param signer: The keypair or secret to use for signing this transaction
            envelope.
        :raise: :exc:`SignatureExistError <paydex_sdk.exception.SignatureExistError>`:
    ...
    def signature_base(self) -> bytes:
        ...
        validators on the Paydex Network will accept.
    ...
    def sign_hashx(self, preimage: bytes) -> None:
        ...
        See Paydex's documentation on `Multi-Sig
