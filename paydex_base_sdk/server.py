...
class Server:
    ...
    the :class:`paydex_sdk.client.requests_client.RequestsClient` instance by default, it is a synchronous HTTPClient,
    you can also specify an asynchronous HTTP Client,
    for example: :class:`paydex_sdk.client.aiohttp_client.AiohttpClient`. If you use a synchronous client,
    ...
    :raises: :exc:`TypeError <paydex_sdk.exceptions.TypeError>`: if the ``client`` does not meet the standard.
    """

    def __init__(
        self,
        horizon_url: str = "https://testhorizon.paydex.io//",
    ...
    def submit_transaction(
        ...
        :param transaction_envelope: :class:`paydex_sdk.transaction_envelope.TransactionEnvelope` object
    ...
    def root(self) -> RootCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.RootCallBuilder` object configured
    ...
    def accounts(self) -> AccountsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.AccountsCallBuilder` object configured
            by a current Horizon server configuration.
        """
    ...
    def assets(self) -> AssetsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.AssetsCallBuilder` object configured by
    ...
    def data(self, account_id: str, data_name: str):
        """
        :return: New :class:`paydex_sdk.call_builder.DataCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def effects(self) -> EffectsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.EffectsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def fee_stats(self) -> FeeStatsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.FeeStatsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def ledgers(self) -> LedgersCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.LedgersCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def offers(self) -> OffersCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.OffersCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def operations(self) -> OperationsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.OperationsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def orderbook(self, selling: Asset, buying: Asset) -> OrderbookCallBuilder:
        ...
        :return: New :class:`paydex_sdk.call_builder.OrderbookCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def paths(
        ...
        :return: New :class:`paydex_sdk.call_builder.PathsCallBuilder` object configured by
            a current Horizon server configuration.
        """

        warnings.warn(
            "Will be removed in version v2.3.0, "
            "use paydex_sdk.server.strict_receive_paths",
            DeprecationWarning,
        )
    ...
    def strict_receive_paths(
        ...
        :param destination_asset: The destination asset.
        :param destination_amount: The amount, denominated in the destination asset, that any returned path should be able to satisfy.
        :return: New :class:`paydex_sdk.call_builder.StrictReceivePathsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def payments(self) -> PaymentsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.PaymentsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def trade_aggregations(
        ...
        :return: New :class:`paydex_sdk.call_builder.TradeAggregationsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def trades(self) -> TradesCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.TradesCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def transactions(self) -> TransactionsCallBuilder:
        """
        :return: New :class:`paydex_sdk.call_builder.TransactionsCallBuilder` object configured by
            a current Horizon server configuration.
        """
    ...
    def load_account(
        ...
        and returns an :class:`paydex_sdk.account.Account` object.

        :param account_id: The account to load.
        :return: an :class:`paydex_sdk.account.Account` object.
        :raises:
            :exc:`ConnectionError <paydex_sdk.exceptions.ConnectionError>`
            :exc:`NotFoundError <paydex_sdk.exceptions.NotFoundError>`
            :exc:`BadRequestError <paydex_sdk.exceptions.BadRequestError>`
            :exc:`BadResponseError <paydex_sdk.exceptions.BadResponseError>`
            :exc:`UnknownRequestError <paydex_sdk.exceptions.UnknownRequestError>`
        """
        if self.__async:
