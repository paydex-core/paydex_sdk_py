...
class BaseCallBuilder:
    ...
    This is an **abstract** class. Do not create this object directly, use :class:`paydex_sdk.server.Server` class.
    ...
    def call(self) -> Union[Dict[str, Any], Coroutine[Any, Any, Dict[str, Any]]]:
        ...
        :raises:
            | :exc:`ConnectionError <paydex_sdk.exceptions.ConnectionError>`: if you have not successfully
                connected to the server.
            | :exc:`NotFoundError <paydex_sdk.exceptions.NotFoundError>`: if status_code == 404
            | :exc:`BadRequestError <paydex_sdk.exceptions.BadRequestError>`: if 400 <= status_code < 500
                and status_code != 404
            | :exc:`BadResponseError <paydex_sdk.exceptions.BadResponseError>`: if 500 <= status_code < 600
            | :exc:`UnknownRequestError <paydex_sdk.exceptions.UnknownRequestError>`: if an unknown error occurs,
