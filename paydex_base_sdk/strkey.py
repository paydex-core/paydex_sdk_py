...
class StrKey:
    ...
    def encode_ed25519_public_key(data: bytes) -> str:
        ...
        :raises:
            :exc:`ValueError <paydex_sdk.exceptions.ValueError>`
            :exc:`TypeError <paydex_sdk.exceptions.TypeError>`
        """
    ...
    def decode_ed25519_public_key(data: str) -> bytes:
        ...
        :return: raw bytes
        :raises:
            :exc:`Ed25519PublicKeyInvalidError <paydex_sdk.exceptions.Ed25519PublicKeyInvalidError>`
        """
        try:
    ...
    def is_valid_ed25519_public_key(public_key: str) -> bool:
        """Returns True if the given Paydex public key is a valid ed25519 public key.

        :param public_key: strkey ed25519 public key to check
        :return: `True` if the given Paydex public key is a valid ed25519 public key.
        """
    ...
    def decode_ed25519_secret_seed(data: str) -> bytes:
        ...
        :return: raw bytes
        :raises:
            :exc:`Ed25519SecretSeedInvalidError <paydex_sdk.exceptions.Ed25519SecretSeedInvalidError>`
        """
        try:
    ...
    def is_valid_ed25519_secret_seed(seed: str):
        """Returns True if the given Paydex secret key is a valid ed25519 secret seed.

        :param seed: strkey ed25519 secret seed
        :return: `True` if the given Paydex secret key is a valid ed25519 secret seed.
        :raises:
            :exc:`ValueError <paydex_sdk.exceptions.ValueError>`
            :exc:`TypeError <paydex_sdk.exceptions.TypeError>`
        """
